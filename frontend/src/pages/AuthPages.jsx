  ...
  >
    <defs>
      ...
      <linearGradient id="authInk" x1="0" y1="0" x2="0" y2="1">
        ...
        <stop offset="1" stopColor="#163DB0" />
      </linearGradient>
    ...
    <g className="auth-scene-stack" filter="url(#authSoft)">
      ...
      <g transform="translate(64 98)">
        ...
        <rect x="14" y="78" width="40" height="14" rx="3" fill="#1E4FD6" opacity="0.18" />
        <text x="22" y="88" fill="#1E4FD6" fontSize="9" fontFamily="IBM Plex Mono, monospace" fontWeight="700">[1]</text>
        <text x="48" y="88" fill="#0E7490" fontSize="9" fontFamily="IBM Plex Mono, monospace" fontWeight="700">[2]</text>
      </g>
    </g>
    ...
    <g className="auth-scene-manuscript" filter="url(#authSoft)">
      ...
      <rect x="198" y="72" width="168" height="22" rx="8" fill="#1E4FD6" />
      <rect x="198" y="86" width="168" height="8" fill="#1E4FD6" />
      ...
      <rect x="218" y="186" width="56" height="18" rx="4" fill="#0E7490" opacity="0.2" />
    ...
    <g className="auth-scene-lens">
      ...
      <circle cx="152" cy="96" r="18" fill="none" stroke="#1E4FD6" strokeWidth="2.5" opacity="0.85" />
      <path d="M172 116 L188 132" stroke="#0E7490" strokeWidth="5" strokeLinecap="round" />
      <circle className="auth-scene-pulse" cx="152" cy="96" r="34" stroke="#1E4FD6" strokeWidth="1.5" fill="none" />
    </g>

    {/* Floating venue chip */}
    <g className="auth-scene-chip">
      <rect x="286" y="42" width="92" height="28" rx="14" fill="#163DB0" />
    ...
    {/* Workflow sparks */}
    <g className="auth-scene-sparks" stroke="#0E7490" strokeWidth="2" strokeLinecap="round">
