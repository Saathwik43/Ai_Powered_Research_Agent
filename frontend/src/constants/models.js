// Keep in step with backend/ai/model_allowlist.py — named models must be allowed there.
export const MODELS = [
  { id: 'groq-default', provider: 'groq', model: null, label: 'Groq (GPT-OSS 120B)', group: 'Other Providers' },
