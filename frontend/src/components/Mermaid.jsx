...
async function ensureMermaidInit() {
  ...
  mermaid.initialize({
    ...
    themeVariables: {
      ...
      fontSize: '14px',
      primaryColor: '#E8EEFC',
      primaryTextColor: '#0F1218',
      primaryBorderColor: '#1E4FD6',
      secondaryColor: '#E0F2FE',
      secondaryTextColor: '#0F1218',
      secondaryBorderColor: '#0E7490',
      tertiaryColor: '#DCFCE7',
      tertiaryTextColor: '#0F1218',
      ...
      xyChart: {
        ...
        titleColor: '#0F1218',
        xAxisTitleColor: '#0F1218',
        xAxisLabelColor: '#0F1218',
        xAxisLineColor: '#0F1218',
        yAxisTitleColor: '#0F1218',
        yAxisLabelColor: '#0F1218',
        yAxisLineColor: '#0F1218',
        plotColorPalette: '#1E4FD6, #0E7490, #15803D, #B45309, #6D28D9, #0284C7, #DC2626',
      },
    },
  });
  initialized = true;
